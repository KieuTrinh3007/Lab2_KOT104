...
fun main() {
    ...
    val sv1 = SinhVienModel("Pham Kieu Trinh", "PH31536", 8.0, false, 20)
    val sv2 = SinhVienModel("Nguyen Van A", "PH42193", 9.0, true, 21)
...
fun ttsv(): SinhVienModel {
    ...
    print("Trạng thái tốt nghiệp (true/false):")
    ...
    var sv = SinhVienModel(tensv, masv, diemtb, datotnghiep, tuoi)
